...
public class ArtaLeleLargeAmountFormatter extends ValueFormatter {
        ...
        public ArtaLeleLargeAmountFormatter() {
         ...
         */
        public ArtaLeleLargeAmountFormatter(String appendix) {
            this();
            mText = appendix;
        }
